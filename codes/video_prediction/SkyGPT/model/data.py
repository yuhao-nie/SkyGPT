...
class VideoData(pl.LightningDataModule):
    ...
    def _dataloader(self, train, pin_memory=True):
    ...
    def train_dataloader(self, pin_memory=True):
        return self._dataloader(True, pin_memory=pin_memory)
    
    def val_dataloader(self, pin_memory=True):
        return self._dataloader(False, pin_memory=pin_memory)

    def test_dataloader(self, pin_memory=True):
        return self.val_dataloader(pin_memory=pin_memory)
