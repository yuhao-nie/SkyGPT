...
|&nbsp; `SkyGPT/model/.py` |Python file contains functions used in ConvLSTM_sky_image_dataset.ipynb notebook.|
...
|&nbsp; `eval/comp_video_pred_models.ipynb` |Jupyter Notebook used to compare the performance of all video prediction models based on the metrics including MAE, MSE and VGG Cosine Similarity.|
