...
<figure>
    ...
    <figcaption style="text-align: justify; font-size: small;">Demonstration of two sample predicted videos by SkyGPT compared to benchmark models. All models starting with the same context, and SkyGPT shows noticeably more accurate and diverse prediction compared with the deteriministic models.</figcaption>
</figure>
